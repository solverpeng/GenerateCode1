...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/product/product/form?id=${product.id}">产品
				<shiro:hasPermission name="product:product:edit">${not empty product.id?'修改':'添加'}
				</shiro:hasPermission>
				<shiro:lacksPermission name="product:product:edit">查看</shiro:lacksPermission>
			</a>
		</li>
	</ul>
	<br/>
