package com.solverpeng.generate;
...
import com.solverpeng.common.utils.DateUtil;
import com.solverpeng.common.utils.FileUtil;
import com.solverpeng.common.utils.FreeMarkerUtil;
...
public class Generate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String packageName = "com.solverpeng.modules";

        String moduleName = "product";            // 模块名
        String subModuleName = "";                // 子模块名（可选）
        String className = "product";            // 类名
        String classAuthor = "solverpeng";        // 类作者
        ...
        // 模板文件路径
        String tplPath = StringUtils.replace(projectPath + "/src/main/java/com/solverpeng/generate/template", "/", separator);
        ...
        content = FreeMarkerUtil.renderTemplate(template, model);
